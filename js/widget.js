...
function(t) {
	...
	function y(t, e) {
		if (null !== t && void 0 !== t) if ("object" != typeof t && (t = [t]), o(t)) for (var n = 0, r = t.length; r > n; n++) e.call(null, t[n], n, t);
		else
	...
	function r(t, e) {
		...
		for (e && null != e.children && (U.length || U.push(e.children), delete e.children); U.length;) if ((r = U.pop()) && void 0 !== r.pop) for (a = r.length; a--;) U.push(r[a]);
	...
	function y(t, e, n, o, r) {
		...
		if (0 !== x) for (var _ = 0; x > _; _++) {
			...
			else if (!p && y > b) for (i = b; y > i; i++) if (void 0 !== d[i] && c(a = d[i], u, r)) {
...
default = c
	...
	var o = {
		...
		cookieValidInDays: 1,
		introMessage: "",
		placeholderText: "Escriba el mensaje...",
