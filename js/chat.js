!function(t) {
	...
	function g(t, e) {
		if (null !== t && void 0 !== t) if ("object" != typeof t && (t = [t]), r(t)) for (var n = 0, o = t.length; o > n; n++) e.call(null, t[n], n, t);
		else
	...
	function o(t, e) {
		...
		for (e && null != e.children && (k.length || k.push(e.children), delete e.children); k.length;) if ((o = k.pop()) && void 0 !== o.pop) for (a = o.length; a--;) k.push(o[a]);
	...
	function g(t, e, n, r, o) {
		...
		if (0 !== x) for (var w = 0; x > w; w++) {
			...
			else if (!p && g > y) for (i = y; g > i; i++) if (void 0 !== d[i] && c(a = d[i], u, o)) {
	...
	}, c.spread = n(28), t.exports = c, t.exports.
default = c
}, function(t) {
	function e(t) {
	...
	function() {
		function t(t) {
			...
			return n && (o.setAttribute("href", e), e = o.href), o.setAttribute("href", e), {
				href : o.href, protocol: o.protocol ? o.protocol.replace(/:$/, "") : "",
				host: o.host,
	...
	e.a = function(t) {
		...
		return a(e, t), e.prototype.componentDidMount = function() {
			...
			Object(r.b)("a", {
				...
				style : "position: absolute; width: 14px; bottom: 6px; right: 6px;", fill: "#EEEEEE",
	...
	e.a = function(t) {
		...
		return i(e, t), e.prototype.render = function(t) {
			...
			n && "video" === n.type ? Object(r.b)("video", {
				height : t.conf.videoHeight, controls: !0,
				autoPlay: !1,
				style: "max-width: 100%;"
			}, Object(r.b)("source", {
				src: n.url,
